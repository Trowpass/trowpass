class FundVirtualCardResponse {
  ...
  factory FundVirtualCardResponse.fromJson(Map<String, dynamic> json) {
    return FundVirtualCardResponse(
      ...
      data: json['data'] != null
          ? FundVirtualCardData.fromJson(json['data'])
          : null,
    );
  }
}

class FundVirtualCardData {
  int id;
  bool isActive;
  String? createdBy;
  String? createdAt;
  ...
  factory FundVirtualCardData.fromJson(Map<String, dynamic> json) {
    return FundVirtualCardData(
      id: json['id'] ?? '',
      ...
      accountUser: json['accountUser'] != null
          ? AccountUser.fromJson(json['accountUser'])
          : null,
    );
  }
}
