...
class PayToBankReceiptScreen extends StatelessWidget {
  PayToBankReceiptScreen({super.key, required this.transactionDetails});
  final PayToBankResponse transactionDetails;
                                ...
                                Padding(
                                  ...
                                  child: ListTile(
                                    title: Align(
                                      alignment: Alignment.center,
                                      child: Text(
                                        'Fund was sent to beneficiary successfully',
