...
class HistorySharePDFPreview extends StatelessWidget {
  final TransactionHistoryData history;
  final controller = Get.put(HistoryDetailsController());

  HistorySharePDFPreview({super.key, required this.history});

  @override
  Widget build(BuildContext context) {
    return ExportFrame(
      frameId: controller.toPDFframeId,
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            StandardButton(
              text: 'Save as PDF',
              onPressed: controller.saveHistoryAsPDF,
            ),
          ],
        ).paddingAll(16),
      ),
