...
class Endpoints {
  ...
  static const String transactionHistoryAll =
      '/api/v1/transaction/histories/{userId}';
  static const String transactionHistorySingle =
  ...
  static const String expenseTypes = 'api/v1/transfer/transport-expenses/all';
