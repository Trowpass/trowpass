...
class Endpoints {
  ...
  static const String userByAccountNumber = 'api/v1/transfer/verify-bank-account';
  ...
  static const String transportWallet = 'api/v1/transfer/top-up-transport-wallet';
  static const String transportCompany = 'api/v1/transfer/transport-company/all';
